...
function NavTabs(props) {
  return (
    <div className="navbar navbar-expand-md navbar-light bg-light sticky-top" id="navigation">
    <div className="container-fluid">
      <a className="navbar-brand" href="index.html"><img id="ck" src={require("./logo.jpg")} className="logo" alt="Logo"
